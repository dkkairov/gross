      ...
      child: Column (
        children: [
          Row(
            ...
            children: [
              Text('Сервисы', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700),)
            ],
          ),
          SizedBox(height: 20,),
          Row(
            children: [
              ...
              Expanded(
                  flex: 4,
                  child: TextButton(
                    onPressed: () {Navigator.of(context).pushNamed("/calculators_main");},
                    child: Column(
                      children: [
      ...
      child: Column(
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
            Text('О приложении', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700))
          ],
          ),
          SizedBox(height: 10,),
          Row(children: [
